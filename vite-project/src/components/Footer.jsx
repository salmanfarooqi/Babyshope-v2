          ...
          <div>
            <div className="flex justify-between flex-wrap w-[80%] md:w-11/12">
              <div className="text-[#6a6a6a] w-[60%] leading-7 mt-10 ">
                ...
                with Furni Website. Explore our curated collection of premium
                furniture and elevate your home with quality craftsmanship and
                timeless design. Shop now and discover the perfect pieces to
                make your house feel like a true sanctuary.
              </div>
              ...
              <div className="flex gap-1.5 mt-10">
                <div className="bg-[#DCE5E4] hover:bg-[#6A6A6A] hover:text-white text-[#6A6A6A] cursor-pointer w-10 h-10 flex items-center justify-center rounded-full text-2xl">
                  <TiSocialFacebook />
                </div>
                <div className="bg-[#DCE5E4] hover:bg-[#6A6A6A] hover:text-white text-[#6A6A6A] cursor-pointer w-10 h-10 flex items-center justify-center rounded-full text-xl">
                  <TiSocialTwitter />
                </div>
                <div className="bg-[#DCE5E4] hover:bg-[#6A6A6A] hover:text-white text-[#6A6A6A] cursor-pointer w-10 h-10 flex items-center justify-center rounded-full text-xl">
                  <CiInstagram />
