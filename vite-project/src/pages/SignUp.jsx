        ...
        <div className="flex justify-center mb-2">
          <div className="w-full lg:w-1/2 border rounded-lg p-5 bg-[#EFF2F1]">
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="block w-full bg-[#6a6a6a] text-white font-semibold py-2 px-4 rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Sign Up</button>
