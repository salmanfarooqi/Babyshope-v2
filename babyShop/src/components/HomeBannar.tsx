...
function HomeBannar({ className,title, description,Button1Classname, buttonText1,Button2Classname, buttonText2,ImageClasss, imageUrl }) {
  return (
    <div className={`${className} w-full  flex items-center justify-center bg-[#6A6A6A] px-5`}>
      <div className='w-full md:w-[87%] flex flex-col md:flex-row'>
        <div className='w-full md:w-[40%] flex flex-col justify-center'>
          ...
          <p className='mt-6 md:mt-10 text-lg md:text-xl font-medium text-[#e6ebe6]'>{description}</p>
        ...
        <div className='w-full md:w-1/2 flex justify-center md:justify-end'>
          {imageUrl && (
          <img src={imageUrl} alt='' className={`${ImageClasss}w-full md:w-auto`} />
)}
        </div>
      </div>
    </div>
